		...
		<view v-if="playShow">
			...
			<view class="play_util">
				<view class="play_util_box">
					<view class="play_util_box_item"><svg t="1632722699880" class="icon" viewBox="0 0 1024 1024"
							version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="6523" width="22" height="18">
							<path
					...
					<view class="play_util_box_item"><svg t="1632722485837" class="icon" viewBox="0 0 1024 1024"
							version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4420" width="22" height="18">
							<path
					...
					<view class="play_util_box_item"><svg t="1632722732436" class="icon" viewBox="0 0 1024 1024"
							version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2414" width="22" height="18">
							<path
								...
								fill="#3D3D3D" p-id="2415"></path>
						</svg>分享</view>
				</view>
			</view>
			<view class="play_list">
				<view class="play_botton">
					<svg t="1632724557885" class="icon" viewBox="0 0 1024 1024" version="1.1"
						xmlns="http://www.w3.org/2000/svg" p-id="7314" width="30" height="20">
						<path
							...
							fill="#d81e06" p-id="7315"></path>
					</svg>
					全部播放({{ playList.trackIds.length }})
				</view>
				<view class="play_song_box">
					<view class="play_song_box_item" v-for="(item, index) in songList" :key="index">
						...
						<view class="play_song_item_detailed">
							...
							<br />
							<span class="play_song_item_al">{{ item.ar[0].name }} - {{ item.al.name }}</span>
						</view>
						<view class="play_song_box_video">
							<svg v-if="item.mv!=0" t="1632733744605" class="icon" viewBox="0 0 1024 1024" version="1.1"
								xmlns="http://www.w3.org/2000/svg" p-id="3356" width="30" height="25">
								<path
								...
								<path
									...
									fill="#4D4D4D" p-id="3359"></path>
							</svg>
						</view>
						<view class="play_song_box_handle">

							<svg t="1632733868517" class="icon" viewBox="0 0 1024 1024" version="1.1"
								xmlns="http://www.w3.org/2000/svg" p-id="4181" width="25" height="15">
								<path
